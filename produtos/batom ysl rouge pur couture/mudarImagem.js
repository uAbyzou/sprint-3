...
imgMenor1.addEventListener("click", function() {
    imgMaior.src = "../../imagens/Produto/batom ysl rouge pur couture/Rouge-pur-Couture_1.png"
});

imgMenor2.addEventListener("click", function() {
    imgMaior.src = "../../imagens/Produto/batom ysl rouge pur couture/Rouge-pur-Couture_2.png"
});

imgMenor3.addEventListener("click", function() {
    imgMaior.src = "../../imagens/Produto/batom ysl rouge pur couture/Rouge-pur-Couture_3.png"
});