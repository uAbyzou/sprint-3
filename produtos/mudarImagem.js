...
imgMenor1.addEventListener("click", function() {
    imgMaior.src = "../../imagens/Produto/Versace eros/Versace eros(1).png"
});

imgMenor2.addEventListener("click", function() {
    imgMaior.src = "../../imagens/Produto/Versace eros/Versace eros(2).png"
});

imgMenor3.addEventListener("click", function() {
    imgMaior.src = "../../imagens/Produto/Versace eros/Versace eros(3).png"
});